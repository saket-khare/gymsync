...
export function GymConfigCard({ gymConfig }: GymConfigCardProps) {
  return (
    <div className="mt-6 sm:mt-8 bg-white dark:bg-[#131316] border border-gray-200 dark:border-zinc-800/60 rounded-xl p-4 sm:p-6 shadow-sm relative overflow-hidden">
